...
class CampaignAnalysisChart extends ChartWidget
{
    ...
    protected function getData(): array
    {
        ...
        $data_end = $this->filters['end_date'] ?? null;
         ...
         // Campaign Type Ids
         $presentation_id = CampaignType::where('name', 'Presentation')->first()->id ?? null;
         $booth_id = CampaignType::where('name', 'Booth')->first()->id ?? null;
         $site_id = CampaignType::where('name', 'Site Visit')->first()->id ?? null;
