...
class SocialMediaCheckinTable extends Component implements HasForms, HasTable
{
    ...
    public static function table(Table $table): Table
    {
        ...
        return $table
            ->query(SocialMediaCheckin::query())
...
//                Tables\Actions\EditAction::make(),
    ...
    {
        return view('livewire.social-media-checkin-table');
    }
}
