        ...
        <div class="" style="margin-top: 6rem">
            ...
            <div class="flex flex-col items-center space-y-4" style="margin-left: 2rem; margin-right: 2rem;">
               ...
               <div class="flex flex-col items-center w-full">
                   ...
                   <button wire:click="redirect_page_to('{{ config('kwyc-check.campaign_url') . '?email=' . $checkin->contact->email . '&mobile=' . $checkin->contact->mobile . '&identifier='.$checkin->registration_code.'&code=ABC123&choice=JN-PPMP-HLTH-IU' }}')"
